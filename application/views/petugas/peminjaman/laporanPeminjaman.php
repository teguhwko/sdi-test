...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Laporan Peminjaman</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Laporan Peminjaman</h5>
                        </div>
                        <div class="card-body">
                            <form id="form">
                                <div class="row">
    ...
    var Controller = (function(uiCtr) {
        ...
        var setupEventListener = function() {
            ...
            $(dom.cetak).on('click', function() {
                var tahun = $('#tahun').val();
                var bulan = $('#bulan').val();
                url = base_url + 'LaporanPeminjaman/cetakLaporan/' + bulan + '/' + tahun;
        ...
        function tampilTabel(bulan, tahun) {
            ...
            table = $("#tabel").dataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "<?php echo base_url() . 'LaporanPeminjaman/getPeminjaman' ?>",
                    "type": "POST",
                    "data": {
                        'bulan': bulan,
                        'tahun': tahun
