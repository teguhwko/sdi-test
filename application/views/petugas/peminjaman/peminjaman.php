      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <a href="<?= base_url('Peminjaman/tambah') ?>" class="btn btn-primary">TAMBAH</a><br><br>
  ...
  var Controller = (function() {
      ...
      $(table).on('click', '.delete', function(e) {
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            window.location = "<?= base_url('Peminjaman/hapus/') ?>" + kode;
          }
        });
      });
    }
    ...
    function tampilTabel() {
      ...
      table = $("#tabel").dataTable({
        ...
        serverSide: true,
        ajax: {
          "url": "<?php echo base_url() . 'Peminjaman/getPeminjaman' ?>",
          "type": "POST"
        },
        columns: [{
