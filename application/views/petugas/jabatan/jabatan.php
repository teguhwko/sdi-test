        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <a href="<?=base_url('Jabatan/tambah')?>" class="btn btn-primary">TAMBAH</a><br><br>
        ...
        $(table).on('click','.delete',function(e){
          ...
          Swal.fire({
              ...
              if (result.value) {
                ...
                window.location = "<?=base_url('Jabatan/Hapus/')?>"+kode;
              }
          });
        });
      }
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'Jabatan/getJabatan'?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "kode_jabatan",
                    "orderable": false,
