                ...
                <div class="col-md-12">
                  <form action="<?= base_url('Karyawan/tambah') ?>" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="radio" name="jenis" id="jenis" class="mt-3" checked value="Laki-Laki">Laki-Laki
                        <input type="radio" name="jenis" id="jenis" class="mt-3 ml-2" value="Perempuan">Perempuan
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <select name="jabatan" id="jabatan" class="form-control">
                        <?php foreach ($jabatan as $r) : ?>
                          <option value="<?= $r['kode_jabatan'] ?>" <?= set_value('jabatan') == $r['kode_jabatan'] ? 'selected' : '' ?>><?= $r['nama_jabatan'] ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="form-group">
